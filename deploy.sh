...
kubectl set image deployments/client-deployment server=vnguyen0804/multi-client:$SHA
kubectl set image deployments/worker-deployment server=vnguyen0804/multi-worker:$SHA
